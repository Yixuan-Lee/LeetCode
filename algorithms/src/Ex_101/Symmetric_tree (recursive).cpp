...
private:
    bool isMirror(TreeNode *p, TreeNode *q) {
        ...
        // the reflection has the same head
        // its left subtree corresponds to its reflection's right subtree
        // its right subtree corresponds to tis reflection's left subtree
        return (p->val == q->val)
